...
@NonNullApi
public class KiwiProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KiwiProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
